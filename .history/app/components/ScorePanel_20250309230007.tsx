    ...
    <div className="absolute top-4 right-4 p-3 bg-gray-800/70 rounded-lg backdrop-blur-md border border-gray-700/50 shadow-lg">
      <div className="flex flex-col gap-2">
        ...
        <div className="space-y-1">
          ...
          <div className="flex justify-between text-sm">
            <span className="text-red-400">红队升级点数</span>
            <span className="text-red-400 font-medium ml-4">{redUpLevel}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-blue-400">蓝队升级点数</span>
            <span className="text-blue-400 font-medium ml-4">{blueUpLevel}</span>
          </div>
        </div>
      </div>
    </div>
