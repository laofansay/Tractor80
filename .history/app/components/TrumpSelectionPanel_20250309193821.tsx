  ...
  return (
    <div className="absolute bottom-4 left-4 p-3 bg-gray-800/70 rounded-lg backdrop-blur-md border border-gray-700/50 shadow-lg">
      <div className="flex flex-col gap-2">
        <div className="text-white text-sm mb-1 font-medium">选择主牌花色</div>
        <div className="flex flex-row gap-2">
          <button
            ...
            title="升级"
          >
            <span>2</span>/<span className='text-red-600 font-bold text-3xl '>2</span>
          </button>
          <button
            onClick={() => onSelectTrump(null)}
        ...
        <div className="text-gray-300 text-xs mt-1">点击选择花色成为庄家</div>
      </div>
    </div>
  );
}