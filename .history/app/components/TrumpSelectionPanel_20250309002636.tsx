...
export function TrumpSelectionPanel({ onSelectTrump, gamePhase }: TrumpSelectionPanelProps) {
  ...
  return (
    <div className="absolute bottom-30 left-4 p-2 bg-green-700 hover:bg-green-600 rounded-lg backdrop-blur-md border border-gray-700/50 shadow-lg">
      <div className="flex flex-row gap-1">
        ...
        <button
          ...
          className="w-10 h-10 hover:bg-red-500 text-white rounded-md transition-colors text-4xl flex items-center justify-center"
          title="红桃"
        >
          ♥️
        </button>
