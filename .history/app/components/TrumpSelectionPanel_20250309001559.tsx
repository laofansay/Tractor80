    ...
    <div className="absolute bottom-4 left-4 p-3 bg-gray-800/70 rounded-lg backdrop-blur-md border border-gray-700/50 shadow-lg">
      <div className="flex flex-row gap-2">
        ...
        <button
          ...
          className="w-10 h-10 bg-red-600 hover:bg-red-500 text-red-600 rounded-md transition-colors text-3xl flex items-center justify-center"
          title="红桃"
        >
          ♥️
        </button>
        <button
          ...
          className="w-10 h-10 bg-green-700 hover:bg-green-600 text-white rounded-md transition-colors text-3xl flex items-center justify-center"
          title="梅花"
        >
          ♣️
        </button>
        <button
          ...
          className="w-10 h-10 bg-blue-600 hover:bg-blue-500 text-white rounded-md transition-colors text-3xl flex items-center justify-center"
          title="方块"
        >
          ♦️
        </button>
