...
export default function Home() {
  ...
  const selectCardsToPlay = (cards: string[], currentRoundData: Record<Position, string[]>, trumpSuit: string | null): string[] => {
    ...
    const isFirstPlayer = Object.values(currentRoundData).every(cards => cards.length === 0 || !cards);
    ...
    if (isFirstPlayer) {
      ...
      if (sameSuitCards.length > 0) {
        ...
        if (nonJokers.length > 0) {
          ...
          return [sortedNonJokers[sortedNonJokers.length - 1]];
        }
      }
