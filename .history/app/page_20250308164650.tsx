...
export default function Home() {
  ...
  const handleBottomCards = (selectedCards: string[]) => {
    ...
    // 庄家选择6张牌扣底
    const newPlayers = { ...players };
    const playerCards = [...newPlayers[dealerPosition].cards];
    ...
    newPlayers[dealerPosition].cards = playerCards;
    setPlayers(newPlayers);
    setBottomCards(selectedCards); // 设置扣底的牌
  ...
  // 出牌
  const playCard = (position: Position, card: string) => {
