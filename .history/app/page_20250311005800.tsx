...
export default function Home() {
  ...
  useEffect(() => {
    ...
    }, [gamePhase, players.north.cards, players.east.Cards, players.south.Cards, players.west.Cards, dealerPosition]);
      ...
      setPlayers(prevPlayers => {
        ...
        if (newPlayers[position].isBot) {
          ...
          if (cardValue === '2' || cardValue === 'J' || cardValue === 'B') {
            ...
            setDealerPosition(position); // 设置庄家位置
            return;
          }
        ...
        if (trumpSuit && newDealerPosition) {
          ...
          // 不在这里设置游戏阶段和当前玩家，而是通过useEffect监听dealerPosition变化来处理
        }
